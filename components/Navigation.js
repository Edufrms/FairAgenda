...
const Navigation = ({ currentView, setView, onExit }) => {
  const items = [
    ...
    { id: 'exhibitors', label: 'Expositores', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { id: 'meetings', label: 'Reuniones', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-20 flex justify-around safe-area-bottom">
      <button 
        onClick={onExit}
        className="flex flex-col items-center py-2 px-1 text-gray-400 hover:text-blue-600"
      >
        ...
        <span className="text-[10px] mt-1">Ferias</span>
      </button>
      ...
      {items.map(item => (
        <button
          ...
          className={`flex flex-col items-center py-2 px-1 flex-1 transition-colors ${currentView === item.id ? 'text-blue-600' : 'text-gray-500'}`}
        >
